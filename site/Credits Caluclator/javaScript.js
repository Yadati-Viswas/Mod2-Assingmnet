try{
        ...
        function fun(num){
           ...
           var a8=document.getElementById("id8").value;
            var a9=document.getElementById("id9").value;
           ...
           var reg=/^([056789]?(10)?$)/
            var r1=reg.test(a1);var r2=reg.test(a2);var r3=reg.test(a3);var r4=reg.test(a4);var r5=reg.test(a5);var r6=reg.test(a6);var r7=reg.test(a7);var r8=reg.test(a8);var r9=reg.test(a9);
               var estimate=r1 &&r2 && r3 &&r4 &&r5 &&r6 &&r7&&r8&&r9 ;
               if(!estimate){
           alert("Please Enter Valid Credits");
               }
           
           else{
           var t=(a1*3+a2*3+a3*4+a4*2+a5*3+a6*3+a7*1.5+a8*1.5+a9*1)/22;
